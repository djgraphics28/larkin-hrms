                        ...
                        <div class="card-header">
                            <div class="custom-control custom-switch">
                                <input {{ $bankSelected ? 'checked' : '' }} type="checkbox"
                                    class="custom-control-input" id="bankSelected" wire:model.live="bankSelected">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-3">
                                    ...
                                    <input {{ !$bankSelected ? 'disabled' : '' }} wire:model="account_name"
                                        type="text" class="form-control" id="account_name">
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="account_number">Account Number</label>
                                    <input {{ !$bankSelected ? 'disabled' : '' }} wire:model="account_number"
                                        type="text" class="form-control" id="account_number">
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="bank_name">Bank Name</label>
                                    <input {{ !$bankSelected ? 'disabled' : '' }} wire:model="bank_name"
