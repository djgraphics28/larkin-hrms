                                    ...
                                    @if (!empty($selectedRows))
                                        <div class="btn-group float-right" role="group" aria-label="Groups">
                                            ...
                                            <button wire:click="generatePdf" type="button"
                                                class="btn btn-danger btn-md mr-2"><i class="fa fa-file-pdf"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            @forelse ($ranges as $dr)
                                                ...
                                                @else
                                                    <th class="text-center {{ $dr['is_sunday'] ? 'bg-danger' : '' }}">
                                                        <small class="text-center text-bold">{{ $dr['day'] }}</small>
                                                    </th>
                                                @endif
                                        ...
                                        @forelse ($records as $data)
                                            <tr>
                                                ...
                                                @forelse ($data['days'] as $item)
                                                    <td
                                                        class="text-center {{ $item['is_sunday'] ? 'bg-danger' : '' }} {{ $item['is_holiday'] ? 'bg-success' : '' }}">
                                                        {{ $item['daily_hours'] }}</td>
                                                @empty
                                                @endforelse
                                            </tr>
