<div>
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Email Variables</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a  href="{{ route('dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a  href="{{ route('email-template') }}">Email
                                Templates</a>
                        </li>
                        <li class="breadcrumb-item active">Email Variables</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="btn-group float-right" role="group" aria-label="Groups">
                                <a  href="{{ route('email-template') }}" type="button"
                                    class="btn btn-secondary btn-md mr-2"><i class="fa fa-arrow-left"
                                        aria-hidden="true"></i> Return to Email Templates</a>
                            ...
                            <table class="table table-condensed table-sm table-hover">
                                <thead class="table-info">
                                    <tr>
                                        ...
                                        <th class="text-start">Variable</th>
                                        ...
                                        <tr wire:key="search-{{ $data->id }}">
                                            <td width="3%" class="text-start align-middle">
                                                <div class="icheck-primary d-inline">
                                                    <input id="emailVariable-{{ $data->id }}" type="checkbox"
                                                        wire:model.live="selectedRows" value="{{ $data->id }}">
                                                    <label for="emailVariable-{{ $data->id }}"></label>
                                                </div>
                                            </td>
                                            <td class="text-start">{{ $data->name }}</td>
                                            <td class="text-start">{{ $data->variable }}</td>
            ...
            <div class="modal-content">
                ...
                <form wire:submit.prevent="submit()">
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="">Email Variable Name</label>
